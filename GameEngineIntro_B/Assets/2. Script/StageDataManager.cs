...
using System.Collections.Generic;
    ...
    {
        public List<StageResult> results = new List<StageResult>();     //StageResult에 집합
    }

    public static class StageResultSaver
    {
        private const string FILE = "stage_result.json";    // 파일 이름
        ...
        public static void SaveStage(int _stage, int _socre)
        {
            ...
            list.results.Add(entry);    // 기존 load 한 데이터에 entry를 추가
        ...
        {
            if (!File.Exists(filePath)) // filePath가 없다면
